...
<head>
    ...
    <title>Babek Login</title>
    <link href="authentications/css/bootstrap.min.css" rel="stylesheet">
    <link href="authentications/css/common.css" rel="stylesheet">


    <link href="https://fonts.googleapis.com/css?family=Rubik:400,600,700&display=swap" rel="stylesheet">
    <link href="authentications/css/theme-05.css" rel="stylesheet">
...
<body>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="">
                            ...
                            <div class="row mt-6 mb-6">
                                ...
                                <div class="col-6 text-right">
                                    <a href="05_reset.html">Forgot password?</a>
                                </div>
                            </div>
                ...
                <div class="right-pane">
                    <div class="text-center" style="width: 300px">
                        <div class="mb-10 forny-logo">
                            <img src="authentications/authentications/img/logo-05.svg">
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            width="296" height="264" viewBox="0 0 296 264">
                            <defs>
                                <style>
                                    .a {
                                        opacity: 0.8;
                                ...
                                <linearGradient id="b" x1="-0.512" y1="7.758" x2="-0.512"
                                    y2="6.717" xlink:href="#a" />
                                <linearGradient id="c" x1="-1.386" y1="7.85" x2="-1.386"
                                    y2="6.809" xlink:href="#a" />
                            </defs>
                            <g class="a" transform="translate(98.3 6.928)">
                                <ellipse class="b" cx="53.831" cy="41.702" rx="53.831"
                                    ry="41.702" />
                            </g>
                            <ellipse class="c" cx="52.636" cy="40.776" rx="52.636" ry="40.776"
                            ...
                            <circle class="i" cx="2.393" cy="2.393" r="2.393"
                                transform="translate(140.448 174.147)" />
                            <circle class="i" cx="2.393" cy="2.393" r="2.393"
                                transform="translate(153.485 178.668)" />
                            <ellipse class="j" cx="3.587" cy="2.393" rx="3.587" ry="2.393"
                                transform="translate(143.033 190.412) rotate(-71.4)" />
                            <circle class="h" cx="3.587" cy="3.587" r="3.587"
                                transform="translate(191.066 173.47)" />
                            <circle class="h" cx="1.794" cy="1.794" r="1.794"
                            ...
                            <g class="a" transform="translate(42.181 37.956)">
                                <ellipse class="b" cx="106.36" cy="28.452" rx="106.36"
                                    ry="28.452" />
                            </g>
                            <path class="h"
                            ...
                            <path class="n"
                                d="M430.853,294.771c58.138,0,105.273-12.316,105.273-27.511H325.58C325.58,282.454,372.714,294.771,430.853,294.771Z"
                                transform="translate(-284.812 -201.722)" />
                            <rect class="n" width="100.487" height="14.356" rx="7.178"
                            ...
                            <g class="k" transform="translate(37.857 93.627)">
                                ...
                                <rect class="p" width="1.103" height="6.248"
                        ...
                        <div class="mt-10">
                            <h4 class="mb-4">Welcome To Babek.</h4>
                            <p>
                                System Babek streamlines company setup with intuitive tools, simplifying the process
                                from registration to operational readiness. Effortlessly navigate the path to
                                entrepreneurship with our user-friendly platform.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <script src="authentications/js/jquery.min.js"></script>
    <script src="authentications/js/bootstrap.min.js"></script>
    <script src="authentications/js/main.js"></script>
    <script src="authentications/js/demo.js"></script>
